...
// Op mobiel iets hoger (bottom-24) zodat hij vrij blijft van de sticky
// "Gratis starten"-balk onderaan; op desktop gewoon rechtsonder.
const WHATSAPP_URL = 'https://wa.me/31855005505'
