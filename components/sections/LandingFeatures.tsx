    ...
    <section className="py-24 px-[5%] bg-[var(--navy3)]">
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-14">
          {label && <p className="font-mono text-[.65rem] text-[var(--accent)] uppercase tracking-[.14em] mb-3">{label}</p>}
          <h2 className="font-outfit font-black text-[var(--text)] tracking-tight leading-[1.15]"
        ...
        <div className={`grid ${gridCols} gap-5`}>
          {features.map((f, i) => (
            ...
            >
              ...
              <h3 className="font-outfit font-bold text-[var(--text)] text-[1rem] mb-2.5">{f.title}</h3>
