export const SITE = {
  ...
  kvk:           '69499829',
  founded:       '2024',
  description:   'CRM-software voor HVAC- en koeltechnisch installateurs. Werkbonnen, installatiebeheer, werkregistratie en F-gassenbalans zoals BRL 100 vraagt, en flesregistratie in één platform.',
...
// KvK-nummer van de eenmanszaak (ook in public/llms.txt). Gaat als
// Organization.identifier in het schema; een KvK-zoek-URL is geen stabiel
// profiel en hoort niet in sameAs.
export const KVK_NUMMER = '69499829'
...
export const INBEGREPEN = [
  ...
  { icon: '📄', label: 'BRL 100-werkregistratie' },
