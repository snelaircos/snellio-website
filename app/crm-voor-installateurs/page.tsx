...
const benefits = [
  ...
  { icon: '❄️', title: 'F-gassen registratie',        desc: 'Koudemiddellogboek per installatie conform art. 7 van EU F-gas 2024/573, flesregistratie en balans zoals BRL 100 vraagt.' },
